...
public class Test {
	...
	public static void main(String[] args) {
		...
		Optional<Employee> maxSalary = l.stream().collect(Collectors.maxBy(Comparator.comparingInt(Employee::getSalary)));
		System.out.println(maxSalary);
		System.out.println();
		
		//2 nd max salary
		System.out.println("--------------------2 nd max salary----------------");
		Optional<Employee> secondMaxSalary = l.stream().sorted(Comparator.comparingInt(Employee::getSalary).reversed()).skip(1).findFirst();
		...
		Optional<Employee> maxSalaryInPirticularCity =l.stream().filter(i->i.getCity().equals(pCity1)).max(Comparator.comparingInt(Employee::getSalary));
		...
		Optional<Employee> secondMaxSalaryInPirticularCity= l.stream().filter(i->i.getCity().equals(pCity2)).sorted(Comparator.comparingInt(Employee::getSalary).reversed()).skip(1).findFirst();
		...
		List<Employee> salaryWiseSortEmployee = l.stream().sorted(Comparator.comparingInt(Employee::getSalary)).collect(Collectors.toList());
		System.out.println(salaryWiseSortEmployee);
		System.out.println();
		
		//sort name wise
		System.out.println("--------------------sort name wise----------------");
		List<Employee> nameWiseSortEmployee =l.stream().sorted(Comparator.comparing(Employee::getName)).collect(Collectors.toList());
		System.out.println(nameWiseSortEmployee);
		System.out.println();
		
		//Id wise sort
		System.out.println("--------------------Id wise sort----------------");
		List<Employee> idWiseSortEmployee =l.stream().sorted(Comparator.comparingInt(Employee::getId)).collect(Collectors.toList());
		System.out.println(idWiseSortEmployee);
		System.out.println();
		
		//pirticular name using contains & equalsIgnoreCase methods
		System.out.println("--------------------pirticular name using contains & equalsIgnoreCase methods----------------");
		List <Employee> containNameEmp=l.stream().filter(i->i.getName().contentEquals("Priya")).collect(Collectors.toList());
		System.out.println(containNameEmp);
		System.out.println();
		List <Employee> equalIngnorCaseNameEmp = l.stream().filter(i->i.getName().equalsIgnoreCase("Priya")).collect(Collectors.toList());
		...
		List<Employee> pirticularCitySalaryIsGreterThan = l.stream().filter(i->i.getCity().contains("Kolhapur")).filter(i->i.getId()>50).collect(Collectors.toList());
